...
public class Patient{
	...
	public String toString() {
		return "Patient [patient_id=" + patientId + ", firstName=" + firstName + ", lastName=" + lastName + "middleInitial=" + middleInitial + "dob=" + DOB + "otherAllergy=" + otherAllergy + "phoneNumer=" + phoneNumber + "email=" + email +  "asthmaAllergy=" + asthmaAllergy + "xraydyeAllergy=" + xraydyeAllergy + "mridyeAllergy=" + mridyeAllergy + "latexAllergy=" + latexAllergy +"notes=" + notes + "Modality=" + Modality +"]";
	}
}
